...
def simpson(func,low,up,N):		# function for Simpson's 1/3 formulae
	...
	sum=h/3*np.sum(y[0:-1:2]+4*y[1::2]+y[2::2])  	# calculating the sum utilizing the numpy array
	return sum
...
def main():
	...
	a1=simpson(func1,0,9,1000)					# Integrate x^2 from 0 to 9
	print('x^2:'+str(a1))
	a2=simpson(func2,0,math.pi/2,1000) 			# Integrate sin(x) from 0 to PI/2
	print('sin(x):'+str(a2))
	a3=simpson(func3,0,math.pi/2,1000) 			# Integrate cos(x) from 0 to PI/2
	print('cos(x):'+str(a3))
